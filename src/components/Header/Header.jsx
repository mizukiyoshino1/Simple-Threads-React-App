        ...
        <div className="header-container">
            ...
            <div className="contents-button-area">
                <button className="home-button" type="button" onClick={goToHomeScreen}>
                    <svg className="home-button-svg" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                ...
                <button className="like-notification-button" type="button" onClick={goToLikeNotificationScreen}>
                    <svg className="like-notification-button-svg" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
                    </svg>
                </button>
                <button className="new-button" type="button" onClick={goToNewPostScreen}>
                    <svg className="new-button-svg" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                ...
                <button className="search-button" type="button" onClick={goToSearchScreen}>
                    <svg className="search-button-svg" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                    </svg>
                </button>
                <button className="profile-button" type="button" onClick={goToProfileScreen}>
                    <svg className="profile-button-svg" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
